    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" && "p-2 group-data-[side=left]:border-r-0 group-data-[side=right]:border-l-0",
          variant === "inset" && "p-2",
    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Hide the rail when sidebar is collapsed to prevent interference with menu items
...
const SidebarMenu = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  return (
    <div ref={ref} data-sidebar="menu" className={cn("flex w-full min-w-0 flex-col gap-1", className)} {...props} />
  )
})
...
const SidebarMenuItem = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return <div ref={ref} data-sidebar="menu-item" className={cn("group/menu-item relative", className)} {...props} />
  },
)
...
>(({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, onClick, ...props }, ref) => {
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="right" align="center" hidden={state !== "closed" || isMobile} {...tooltip} />
    </Tooltip>
  )
})
...
const SidebarMenuSubItem = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ ...props }, ref) => {
